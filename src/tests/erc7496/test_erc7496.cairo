...
use erc7496::erc7496::interface::IERC7496_ID;
use erc7496::presets::erc721_dynamic_traits::{
    ERC721DynamicTraits,
...
fn UNAUTHORIZED_USER() -> ContractAddress {
    contract_address_const::<'U_USER'>()
}

fn METADATA_URI() -> ByteArray {
    "https://exampleerc.com/labels.json"
}

fn deploy() -> (IERC721DynamicTraitsMixinDispatcher, ContractAddress) {
...
fn test_returns_value_set() {
    let (token, contract_address) = deploy();
